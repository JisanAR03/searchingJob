    ...
    <div class="w-11/12 md:w-1/2 lg:w-5/12">
      <div class="space-y-6 w-full">
        ...
        <form action="{{route('job-seekers-registration')}}" method="POST" class="space-y-3">@csrf
          ...
          <div>
            <button class="bg-button rounded-xl text-white py-2 px-4 w-full">Sign Up</button>
          </div>
        </form>
        ...
        {{-- <a href="{{ route('register.provider', ['provider' => 'facebook']) }}" class="flex justify-center w-full text-[#1877F2] border border-[#1877F2] rounded-xl py-2 cursor-pointer">
          <button type="button" data-te-ripple-init data-te-ripple-color="light" class="mr-2 inline-block rounded-sm px-1 py-1 text-xs font-medium bg-[#1877F2] text-white">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16"> <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/> </svg>                    
          </button> Applying With Facebook
        </a> --}}
